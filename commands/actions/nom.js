...
module.exports = {
    ...
    .addUserOption(option => option.setName('cuteuser').setDescription('Person to nom').setRequired(true)),

    async execute(interaction) {
        const query = 'anime nom';
        const limit = 25;
        const mediaFilter = 'minimal';
        const nom = interaction.options.getUser('cuteuser');
        ...
        .setDescription(`${interaction.user.username} nomed ${nom} ❤️`)
        .setImage(gifUrl);
