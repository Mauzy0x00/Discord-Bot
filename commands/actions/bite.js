...
module.exports = {
    ...
    .addUserOption(option => option.setName('cuteuser').setDescription('Person to bite').setRequired(true)),

    async execute(interaction) {
        const query = 'cute bite';
        const limit = 25;
        const mediaFilter = 'minimal';
        const bite = interaction.options.getUser('cuteuser');
        ...
        .setDescription(`${interaction.user.username} bit ${bite}`)
        .setImage(gifUrl);
